...
namespace gamelib3d
{
    public class camera
    {
        ...
        public void setsideon(Vector3 character_position, Vector3 character_rotation, float distancefromcharacter, float distanceabove, float distanceinfront)
        {
    ...
    public class staticmesh
    {
        ...
        public staticmesh(ContentManager content, string modelname, float msize, Vector3 mpos, Vector3 mrot, Vector3 evol)
        {
